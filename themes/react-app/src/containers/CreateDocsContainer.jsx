  ...
  render() {
    ...
    return (
      <Fragment>
            ...
            <Fragment>
              <div className={classes.buttonWrap}>
                <Button
                  ...
                  color="primary"
                  type="submit"
                  onClick={() => this.handlePageChange("/create/category")}>
                ...
                <Button
                  ...
                  color="primary"
                  type="submit"
                  onClick={() => this.handlePageChange("/create/method")}>
                  <div className={classes.btnContents}>
                ...
                <Button
                  ...
                  color="primary"
                  type="submit"
                  onClick={() => this.handlePageChange("/create/language")}>
                  <div className={classes.btnContents}>
                ...
                <Button
                  ...
                  color="primary"
                  type="submit"
                  onClick={() => this.handlePageChange("/create/code-sample")}>
                  <div className={classes.btnContents}>
                    <CodeIcon className={classes.iconBig} />
                    Add Code Sample
                  </div>
        ...
        <Route path={match.url + "/category"} component={AddCategory} />
        <Route path={match.url + "/method"} component={AddMethod} />
        <Route path={match.url + "/language"} component={AddLanguage} />
        <Route path={match.url + "/code-sample"} component={AddCodeSample} />
